package braincrush.mirza.com.MMusic.models
 ...
 */
class Audio(var data: String?, var title: String?, var album: String?, var artist: String?, var endTime: String, var duration: Long, var playing: Boolean) : Parcelable {
